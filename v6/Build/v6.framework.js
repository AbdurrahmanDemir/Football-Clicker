...
function _SDK_CallHighScore(score, board_id) {
...
function _SDK_Init(devID, pubID) {
...
function _SDK_PlayRewardAd() {
 if (this.rewardAdAvailable) {
  this.rewardAdFunction();
 }
}

function _SDK_SaveAchievement(award) {
...
var asmLibraryArg = {
 ...
 "SDK_CallHighScore": _SDK_CallHighScore,
 "SDK_CheckRewardAd": _SDK_CheckRewardAd,
 "SDK_Init": _SDK_Init,
 "SDK_PlayRewardAd": _SDK_PlayRewardAd,
 "SDK_SaveAchievement": _SDK_SaveAchievement,
 "SDK_ShowAd": _SDK_ShowAd,
